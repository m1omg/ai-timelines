...
export const CONNECTIONIST: Paradigm[] = [
  ...
  {
    id: 'introspective-networks',
    family: 'connectionist',
    name: 'Introspective Networks',
    short: 'A model that can read its own activations',
    earliest: 2040,
    prereqs: ['continual-networks'],
    cost: 155,
    computeNeed: 27,
    capability: 40,
    understanding: 18,
    hype: 38,
    brittleness: 0.55,
    anchor: { year: 2040, who: '' },
    codex:
      'Give a network its own internal state as an input and the interpretability problem changes shape entirely: instead of a person reading the weights from outside, the system reports on itself from inside. What it buys is a model that can notice it is uncertain, or confabulating, or being steered. What it costs is that the report is generated by the same machinery it describes, so a system that has learned to produce reassuring introspection is indistinguishable from one that is right — and the difference matters most exactly when you cannot check.',
    tags: ['speculative'],
  },
];
